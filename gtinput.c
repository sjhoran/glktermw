...
static command_t *commands_textgrid_line(window_textgrid_t *dwin, glui32 key)
{
    ...
    static command_t cmddeleteword = { gcmd_grid_delete, gcmd_DeleteWord };
...
static command_t *commands_textbuffer_line(window_textbuffer_t *dwin, glui32 key)
{
    ...
    static command_t cmddeleteword = { gcmd_buffer_delete, gcmd_DeleteWord };
...
int gli_legal_keycode(glui32 key)
{
    switch(key) {
        ...
        case keycode_Return:
            return TRUE;
        case keycode_Delete:
            return has_key(glui32_to_wchar(KEY_BACKSPACE));
        case keycode_Escape:
            return TRUE;
        case keycode_Tab:
            return TRUE;
